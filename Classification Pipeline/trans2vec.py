...
class trans2vec(object):
    ...
    def load_data(self):
        ...
        self.amount_data = self.DataFrame['weight'].values
    ...
    def walk(self):
        ...
        # Dimensions = Size or vector_size depending on word2vec version
        #word2vec_model = Word2Vec(sentences=walks, size=self.dimensions, window=self.window_size,
